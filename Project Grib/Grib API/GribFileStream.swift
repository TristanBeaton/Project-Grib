...
class GribFileStream {
    ...
    private func loadBitBuffer() throws {
        ...
        for i in 0 ..< 8 {
            ...
            self.bits.append((byte << UInt8(i)) >> 7)
        }
    }
    ...
    func readBits(_ length:Int) throws -> UInt {
        ...
        for _ in 0 ..< length {
            ...
            value = value << 1 | UInt(try self.readBit())
        }
    ...
    func readInt16() throws -> Int16 {
        ...
        return Int16((1 - ((data[0] & 128) >> 6)) * ((data[0] & 127) << 8 | data[1]))
    }
    ...
    func readInt24() throws -> Int32 {
        ...
        return Int32((1 - ((data[0] & 128) >> 6)) * ((data[0] & 127) << 16 | data[1] << 8 | data[2]))
    }
    ...
    func readString(_ length:Int) throws -> String {
        ...
        for _ in 0 ..< length {
            ...
            bytes.append(UInt8(try self.readBits(8)))
        }
    ...
    func moveToStart() throws -> Bool {
        ...
        while stream.hasBytesAvailable {
            ...
            if data == grib[0] {
                ...
                if arr[0] == grib[1] && arr[1] == grib[2] && arr[2] == grib[3] {
